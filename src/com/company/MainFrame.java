...
public class MainFrame extends JFrame {
    ...
    public Double calculate1(Double x, Double y, Double z) {
        return ((1/Math.pow(x,0.5)+Math.cos(Math.exp(y))+Math.cos(Math.pow(z,2)))/
                (Math.pow(Math.log(Math.pow(1+z,2))+Math.pow(Math.exp(Math.cos(y))+Math.pow(Math.sin(Math.PI*x),2),2),0.33)));
